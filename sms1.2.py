...
\033[37m    /_/ \033[32m( \033[37mSpam Sms \033[33mMatahari \033[32m| \033[37mBY \033[33mChandrika \033[32m) \033[32m(\033[37mV.1.2\033[32m)
\033[32m[•]───────────────────────────────────────────[•]
\033[32m | [+]  Crator  : Chandrika 		       |
\033[32m | [+]  Facebook :\033[90m Chika Pro		       |
\033[32m | [+]  Github : ChikaPro                      |
\033[32m | [+]  Status Sc  : Free	               |
\033[32m[•]───────────────────────────────────────────[•]"""
os.system('clear')
print (banner)
...
if no =='':
   exit('\033[37m[\033[31m!\033[37m] Tdk boleh kosong')
elif len(no) <= 9:
   exit('\033[37m[\033[31m!\033[37m] Nomor Tdk cocok ')
else:
...
for i in range(jml):
      ...
      time.sleep(2)
print ('\n\033[37m[\033[32m√\033[37m] \033[37mProses Selesai \033[33m:>')
